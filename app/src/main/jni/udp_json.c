...
void udp_server()
{
    ...
    while (1) {
        ...
        if (ret <= 0) {
            ...
            //if(memcmp(inet_ntoa(sender.sin_addr), local_ip, 13) == 0)
             //   continue;
