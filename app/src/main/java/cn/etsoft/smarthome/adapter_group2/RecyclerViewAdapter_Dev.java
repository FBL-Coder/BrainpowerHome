...
public class RecyclerViewAdapter_Dev extends RecyclerView.Adapter<RecyclerViewAdapter_Dev.SceneViewHolder> {
    ...
    public SceneViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.horizontal_list_item2, null);
    ...
    public void onBindViewHolder(final SceneViewHolder holder, final int position) {
        ...
        if (mPosition == position) {
            ...
            holder.itemView.setBackgroundResource(R.color.color_88222223);  //其他项背景
        }
