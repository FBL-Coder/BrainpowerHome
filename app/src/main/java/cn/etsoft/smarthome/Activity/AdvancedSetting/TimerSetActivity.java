...
public class TimerSetActivity extends BaseActivity {
    ...
    private LinearLayout mTimer_LinearLayout;
    @Override
    public void initView() {
        setLayout(R.layout.activity_timer);
        layout = getViewById(R.id.Timer_CircleMenu);
        mTimer_LinearLayout  = getViewById(R.id.Timer_LinearLayout);
    ...
    private void initEvent() {
        layout.setOnInnerCircleLayoutClickListener(new CircleMenuLayout.OnInnerCircleLayoutClickListener() {
            ...
            public void onClickInnerCircle(int position, View view) {
                ...
                Toast.makeText(TimerSetActivity.this, Data_InnerCircleList.get(position).getTitle(), Toast.LENGTH_SHORT).show();
            }
        });
        layout.setOnOuterCircleLayoutClickListener(new CircleMenuLayout.OnOuterCircleLayoutClickListener() {
            ...
            public void onClickOuterCircle(int position, View view) {
                Toast.makeText(TimerSetActivity.this, Data_OuterCircleList.get(position).getTitle(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    /**
