...
public class TimerInfo_DevAdapter extends BaseAdapter {

    private List<Timer_Data.TimerEventRowsBean.RunDevItemBean> timer_list;
    private Context mContext;

    public TimerInfo_DevAdapter(List<Timer_Data.TimerEventRowsBean.RunDevItemBean> list, Context context) {
        timer_list = list;
        mContext = context;
    }
