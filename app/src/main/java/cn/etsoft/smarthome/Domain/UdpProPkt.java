...
public class UdpProPkt {
	...
	public static enum E_UDP_RPO_DAT {
		...
		e_udpPro_keyName_alarm(62), e_udpPro_test_dat(63), e_udpPro_report_io_info(64), e_udpPro_group_operation(65),e_udpPro_getGroupInfo(66),
		e_udpPro_getBroadCast(80),e_udpPro_regeditUser(81),e_udpPro_loginUser(82),e_udpPro_regeditRcu(83)
		,e_udpPro_delRcu(84),e_udpPro_setRemoteAddr(85),e_udpPro_getShortcutKey(86),e_udpPro_setShortcutKey(87),e_udpPro_State(100);
