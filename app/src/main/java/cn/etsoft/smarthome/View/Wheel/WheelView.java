package cn.etsoft.smarthome.View.Wheel;
...
public class WheelView extends View implements GestureDetector.OnGestureListener {
	...
	private double Adaptive_coefficient;
	...
	protected void init(AttributeSet attrs) {
		...
		mCursorSize = density * (int)(18/Adaptive_coefficient);
		mCenterTextSize = density * (int)(22/Adaptive_coefficient);
		mNormalTextSize = density * (int)(18/Adaptive_coefficient);
		mBottomSpace = density * (int)(6/Adaptive_coefficient);
		...
		mTopSpace = mCursorSize + density * (int)(2/Adaptive_coefficient);
