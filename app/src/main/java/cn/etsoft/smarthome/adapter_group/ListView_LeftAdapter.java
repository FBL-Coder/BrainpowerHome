 ...
 */
public class ListView_LeftAdapter extends BaseAdapter {
    private Context context;
    private List<String> room_list;
    private List<String> room_list_ok;
    int mSelect = 0;   //选中项

    public ListView_LeftAdapter(Context context) {
    ...
    public ListView_LeftAdapter(Context context, List<String> room_list) {
        room_list_ok = new ArrayList<>();
