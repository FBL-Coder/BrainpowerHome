...
import cn.etsoft.smarthome.yuyin.recognization.IRecogListener;
import cn.etsoft.smarthome.yuyin.recognization.RecogEventAdapter;
...
//        Logger.info(TAG + ".Debug", "asr params(反馈请带上此行日志):" + json);
        Log.i(TAG, "asr params(反馈请带上此行日志):" + json);
