 ...
 * 设备控制
 */
public class Equipment_control2 extends FragmentActivity{
    ...
    private void initData() {
        editDevFragment = new EditDevFragment(Equipment_control2.this);
        editModuleFragment = new EditModuleFragment(Equipment_control2.this);
