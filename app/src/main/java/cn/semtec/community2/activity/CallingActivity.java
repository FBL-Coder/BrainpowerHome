...
public class CallingActivity extends MyBaseActivity implements OnClickListener {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 1:
                    ...
                    tv_handFree.setText(getString(cn.etsoft.smarthome.R.string.calling_handFree));
                    iv_handFree.setBackgroundResource(cn.etsoft.smarthome.R.drawable.calling_handfree);
                    break;
                default:
                    break;
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(cn.etsoft.smarthome.R.layout.activity_calling);
        ismute = false;
        instance = this;
