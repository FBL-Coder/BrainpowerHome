...
import cn.semtec.community2.entity.BleSppGattAttributes;
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
               ...
               // service.getInstanceId()
                if (service!=null)
                {
                    //默认找到B-0006/tl8266的服务，继续查找B-0006/tl8266的特征值
...
//    	BaseActivity.instance.isMyConnect = true;
    ...
    private boolean isEnd;
   	public void scanBlue(boolean boo) {
   		isEnd = boo;
   			...
   			public void run() {
   				...
   				while (isEnd) {
   					...
   					if(BaseActivity.instance != null && isEnd){
   						BaseActivity.instance.isDisplayDialog = false;
   						BaseActivity.instance.startScanBlue();
   					}
   				}
   			}
   		}).start();
