...
public class RainDropView extends View {
    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, com.example.abc.mybaseactivity.R.styleable.RainDropView, 0, 0);
            try {
                ...
                if(a.hasValue(com.example.abc.mybaseactivity.R.styleable.RainDropView_waterdrop_color)){
                   int waterDropColor =  a.getColor(com.example.abc.mybaseactivity.R.styleable.RainDropView_waterdrop_color, Color.GRAY);
                    mPaint.setColor(waterDropColor);
                }
                if (a.hasValue(com.example.abc.mybaseactivity.R.styleable.RainDropView_max_circle_radius)) {
                    mMaxCircleRadius = a.getDimensionPixelSize(com.example.abc.mybaseactivity.R.styleable.RainDropView_max_circle_radius, 0);
                ...
                if (a.hasValue(com.example.abc.mybaseactivity.R.styleable.RainDropView_min_circle_radius)) {
                    mMinCircleRaidus = a.getDimensionPixelSize(com.example.abc.mybaseactivity.R.styleable.RainDropView_min_circle_radius, 0);
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        Drawable drawable = getResources().getDrawable(com.example.abc.mybaseactivity.R.drawable.refresh_arrow);
