...
public class ToastUtil {
    ...
    private static Toast InnerCreater(Context context, CharSequence info, int duration) {
        ...
        if (context != null) {
            ...
            View vContent = inflater.inflate(com.example.abc.mybaseactivity.R.layout.activity_toast, null);
            TextView mTvContent = (TextView) vContent.findViewById(com.example.abc.mybaseactivity.R.id.tv_content);
